...
int main(int argc, char** argv){
    ...
    double lep_ThetaI, b1_ThetaI, b2_ThetaI, j1_ThetaI, j2_ThetaI;
    double lep_PtI, b1_PtI, b2_PtI, j1_PtI, j2_PtI;
    ...
    tree->Branch("lep_PtI", &lep_PtI);
    tree->Branch("b1_PtI", &b1_PtI);
    tree->Branch("b2_PtI", &b2_PtI);
    tree->Branch("j1_PtI", &j1_PtI);
    tree->Branch("j2_PtI", &j2_PtI);

    double lep_PxF, lep_PyF, b1_PxF, b1_PyF, b2_PxF, b2_PyF, j1_PxF, j1_PyF, j2_PxF, j2_PyF, nu_PxF, nu_PyF;
    double lep_ThetaF, b1_ThetaF, b2_ThetaF, j1_ThetaF, j2_ThetaF;
    double somma_PxF = 0, somma_PyF = 0;
    double lep_PzF, lep_E, b1_PzF, b1_E, b2_PzF, b2_E, j1_PzF, j1_E, j2_PzF, j2_E;
    double lep_PtF, b1_PtF, b2_PtF, j1_PtF, j2_PtF;
    ...
    tree->Branch("lep_PtF", &lep_PtF);
    tree->Branch("b1_PtF", &b1_PtF);
    tree->Branch("b2_PtF", &b2_PtF);
    tree->Branch("j1_PtF", &j1_PtF);
    tree->Branch("j2_PtF", &j2_PtF);
    ...
    while ( reader.readEvent() ){
        ...
        for (int iPart = 0 ; iPart < reader.hepeup.IDUP.size(); iPart++){
            ...
            if (reader.hepeup.ISTUP.at (iPart) == 1) {
                ...
                if (abs(ID) == 11 || abs(ID) == 13 ){ 
                    ...
                    //ricavo le variabili di cui voglio avere un confronto                    
        ...
        if(tau == 0) {
            ...
            j1_PtF = jet_j1_mom.Pt();

            //SECONDO QUARK
            j2_ThetaI = jet_j2_mom.Theta();
            j2_PtI = jet_j2_mom.Pt();
